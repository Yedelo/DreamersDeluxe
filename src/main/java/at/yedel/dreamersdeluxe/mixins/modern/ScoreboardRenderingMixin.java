...
public abstract class ScoreboardRenderingMixin {
    //~ if < 26.2 'Hud' -> 'Gui'
    @ModifyExpressionValue(method = "displayScoreboardSidebar", at = @At(value = "FIELD", target = "Lnet/minecraft/client/gui/Gui$1DisplayEntry;name:Lnet/minecraft/network/chat/Component;"))
