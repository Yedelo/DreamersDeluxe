...
public class Requests {
	...
	static {
		try {
			...
			myKeyStore.load(Requests.class.getResourceAsStream("/dreamersdeluxe_keystore.jks"), "changeit".toCharArray());
			...
			DreamersDeluxe.LOGGER.error("Failed to load keystore! Update checking and my messages won't work on older java versions.", e);
			DreamersDeluxe.LOGGER.info("Current java version: {}", System.getProperty("java.version"));
			context = null;
		}
	}
